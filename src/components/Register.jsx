  ...
  return (
    <>
      ...
      <Form method='post' className='flex flex-col max-w-xl'>
        ...
        <input type="file" onChange={(Event) => console.log(Event.target.files[0].blob())} accept='image/*' id="file" name='file' className="border border-gray-300 text-gray-900 text-lg rounded-lg focus:ring-blue-500 focus:border-blue-500 focus:bg-slate-50 block w-full ps-4 p-2" placeholder="Unique password" required />
