  ...
  return (
    <>
      ...
      <Form className='flex flex-col max-w-xl'>
        ...
        <input type="password" id="password" name='password' className="border border-gray-300 text-gray-900 text-lg rounded-lg focus:ring-blue-500 focus:border-blue-500 focus:bg-slate-50 block w-full ps-4 p-2" placeholder="Special password" required />
        <p className='text-red-700'>Some error message!</p>
